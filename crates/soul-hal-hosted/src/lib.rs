...
fn keycode_to_char(kc: Keycode, shift: bool) -> Option<char> {
    ...
    Some(match kc {
        ...
        K::Y => 'y', K::Z => 'z',
        K::Num0 if shift => ')', K::Num0 => '0',
        K::Num1 if shift => '!', K::Num1 => '1',
        K::Num2 if shift => '@', K::Num2 => '2',
        K::Num3 if shift => '#', K::Num3 => '3',
        K::Num4 if shift => '$', K::Num4 => '4',
        K::Num5 if shift => '%', K::Num5 => '5',
        K::Num6 if shift => '^', K::Num6 => '6',
        K::Num7 if shift => '&', K::Num7 => '7',
        K::Num8 if shift => '*', K::Num8 => '8',
        K::Num9 if shift => '(', K::Num9 => '9',
        K::Space => ' ',
        K::Period if shift => '>', K::Period => '.',
        K::Comma if shift => '<', K::Comma => ',',
        K::Minus if shift => '_', K::Minus => '-',
        K::Equals if shift => '+', K::Equals => '=',
        K::Slash if shift => '?', K::Slash => '/',
        K::Backslash if shift => '|', K::Backslash => '\\',
        K::Semicolon if shift => ':', K::Semicolon => ';',
        K::Quote if shift => '"', K::Quote => '\'',
        K::Backquote if shift => '~', K::Backquote => '`',
        K::LeftBracket if shift => '{', K::LeftBracket => '[',
        K::RightBracket if shift => '}', K::RightBracket => ']',
        _ => return None,
    })
}
