//! Host: routes events, manages the navigation stack, owns every app slot.
...
use soul_core::{
    App, Ctx, Event, HardButton, KeyCode, APP_HEIGHT, SCREEN_WIDTH, SYSTEM_STRIP_H,
};
use soul_script::ScriptedApp;
use soul_ui::{hit_test, BLACK, WHITE};
use std::path::{Path, PathBuf};

use crate::builder::MobileBuilder;
use crate::draw::Draw;
use crate::egui_demo::EguiDemo;
